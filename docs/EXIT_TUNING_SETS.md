...
- canonical 기본값: [config/runtime.toml](config/runtime.toml)
- canonical 세트: [config/sets](config/sets)
- 현재 적용 override: [config/runtime.local.toml](config/runtime.local.toml)

현재 canonical 문서입니다.

상세 내용

- [EXIT_TUNING_SETS_2026-03-28.md](docs/EXIT_TUNING_SETS_2026-03-28.md)
...
- [config/sets/conservative.toml](config/sets/conservative.toml)
- [config/sets/medium.toml](config/sets/medium.toml)
